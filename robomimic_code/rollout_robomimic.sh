...
#SBATCH --job-name=rollout_robomimic
#SBATCH --output=rollout_robomimic.out
#SBATCH --error=rollout_robomimic.err
...
apptainer exec --nv --fakeroot --writable-tmpfs --bind /apps:/apps /scratch1/rnene/dinoenv.sif bash -lc "
  ...
  python robomimic_code/rollout_robomimic.py \
    ...
    --num_hist 3 \
    --min_horizon 4 \
    --output_dir /project2/jessetho_1732/rl_eval_wm/dino_wm/eval_results/robomimic_rollout \
    --save_video \
    --video_fps 10 \
    --seed 42
"
