...
#SBATCH --job-name=compare_success_robomimic
#SBATCH --output=compare_success_robomimic.out
#SBATCH --error=compare_success_robomimic.err
...
apptainer exec --nv --fakeroot --writable-tmpfs --bind /apps:/apps /scratch1/rnene/dinoenv.sif bash -lc "
  ...
  cd /project2/jessetho_1732/rl_eval_wm/dino_wm
  python robomimic_code/compare_success_robomimic.py \
